    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                echo \Custom\widgets\Menu::widget();
                //
                NavBar::begin([
                    'brandLabel' => 'Home',
                    'brandUrl' => Yii::$app->homeUrl,
                    'options' => [
                        'class' => 'nav nav-list treeview',
                    ],
                ]);
                    ...
                    'items' => [
                        [
                            ...
                            'items' => [
                                ...
                                ['label' => 'Danh sách quản lý toa', 'url' => ['/wagon']],
                                '<li></li>',
                                ['label' => 'Xác nhận toa xe', 'url' => '#'],
                                '<li class="divider"></li>',
                                ['label' => 'Lich hẹn sửa chữa', 'url' => ['/date-repair']],
                                '<li class="divider"></li>',
                                ['label' => 'Hãng sửa chữa', 'url' => ['/brand-repair']],
                            ],
                        ],
                        [
                            ...
                            'items' => [
                                ...
                                ['label' => 'Thêm mới ga xe', 'url' => ['/station/create']],
                                '<li class="divider"></li>',
                                ['label' => 'Danh sách ga xe', 'url' => ['/station']],
                            ],
                        ],
                        [
                        ...
                        Yii::$app->user->isGuest ?
                            ...
                            [
                                ...
                                'items' => [
                                    // '<li class="dropdown-header">Quản lý người dùng</li>',
                                    ['label' => 'Thông tin tài khoản', 'url' => ['user/profile']],
                                    '<li class="divider"></li>',
...
<!--                <li class="active">Dashboard</li>-->
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; My Company <?= date('Y') ?> All rights reserved.
    </footer>
